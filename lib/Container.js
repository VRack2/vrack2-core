...
/***** ********      DEVICE ERROR      ********************/
ErrorManager_1.default.register('Container', 'CTR_DEVICE_DUPLICATE', 'Device id is duplicated', {});
ErrorManager_1.default.register('Container', 'CTR_DEVICE_ACTION_NF', 'Action on device not found', {
...
ErrorManager_1.default.register('Container', 'CTR_DEVICE_NF', 'Device in container NOT found', {
    device: Rule_1.default.string().description('Device ID'),
});
ErrorManager_1.default.register('Container', 'CTR_DEVICE_ACTION_HANDLER_NF', 'Device handler action not found', {
    device: Rule_1.default.string().description('Device ID'),
    action: Rule_1.default.string().description('Device action name'),
});
ErrorManager_1.default.register('Container', 'CTR_DEVICE_PROCESS_EXCEPTION', 'During process execution - the device threw an exception', {
    device: Rule_1.default.string().description('Device ID'),
});
ErrorManager_1.default.register('Container', 'CTR_DEVICE_PROCESS_PROMISE_EXCEPTION', 'During processPromise execution - the device threw an exception', {
    device: Rule_1.default.string().description('Device ID'),
});
ErrorManager_1.default.register('Container', 'CTR_DEVICE_STOP_EXCEPTION', 'During stop execution - the device threw an exception', {
    device: Rule_1.default.string().description('Device ID'),
});
ErrorManager_1.default.register('Container', 'CTR_DEVICE_STOP_PROMISE_EXCEPTION', 'During stopPromise execution - the device threw an exception', {
    device: Rule_1.default.string().description('Device ID'),
});
ErrorManager_1.default.register('Container', 'CTR_DEVICE_STOP_ALL_EXCEPTION', 'During stopAll execution - one or more devices failed to stop', {});
ErrorManager_1.default.register('Container', 'CTR_DEVICE_STOPPED', 'Device is not running - the action is rejected', {
    device: Rule_1.default.string().description('Device ID'),
    action: Rule_1.default.string().description('Device action name'),
});
/***** ********      PORTS ERROR      ********************/
ErrorManager_1.default.register('Container', 'CTR_INCORRECT_DYNAMIC_PN', 'Incorrect dynamic port name', {
    port: Rule_1.default.string().description('Incorrect port name')
});
ErrorManager_1.default.register('Container', 'CTR_INCORRECT_PN', 'Incorrect port name', {
    port: Rule_1.default.string().description('Incorrect port name')
});
ErrorManager_1.default.register('Container', 'CTR_INPUT_HANDLER_NF', 'Port input handler not found', {
    port: Rule_1.default.string().description('Port name for handler'),
    handler: Rule_1.default.string().description('Handler name')
});
ErrorManager_1.default.register('Container', 'CTR_DEVICE_PORT_NF', 'Port on device not found', {
    port: Rule_1.default.string().description('Port name'),
});
/***** ********      CONNECTION ERROR      ********************/
ErrorManager_1.default.register('Container', 'CTR_CONNECTION_INCORRECT', 'Incorrect connection format', {
...
ErrorManager_1.default.register('Container', 'CTR_CONNECTION_DEVICE_NF', 'Connection device not found', {
    connection: Rule_1.default.string().description('Connection string'),
    device: Rule_1.default.string().description('Device name not found')
});
ErrorManager_1.default.register('Container', 'CTR_CONNECTION_PORT_NF', 'Connection port not found', {
    connection: Rule_1.default.string().description('Connection string'),
    port: Rule_1.default.string().description('Port name not found')
});
ErrorManager_1.default.register('Container', 'CTR_INCOMPATIBLE_PORTS', 'Incompatible ports', {
    connection: Rule_1.default.string().description('Connection string'),
});
ErrorManager_1.default.register('Container', 'CTR_INCORRECT_BOOTSTRAP', 'The required DeviceManager class is not specified correctly', {});
ErrorManager_1.default.register('Container', 'CTR_IGNORE_SERVICE_AUTORELOAD', 'Error that ignores service restart flag', {});
/**
