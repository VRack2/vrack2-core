...
ErrorManager_1.default.register('StructureStorage', 'SS_STRUCT_NOT_FOUND', 'Structure ID not found', {
    id: Rule_1.default.string().required().example('vrack').description('Structure id')
});
/**
...
class StructureStorage extends BootClass_1.default {
    checkOptions() {
        return {
            structureDir: Rule_1.default.string().required().default('./structure')
        };
    }
    process() {
