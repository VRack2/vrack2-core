...
ErrorManager_1.default.register('ImportManager', 'IM_FILE_NOT_FOUND', 'Import file not found', {
    filePath: Rule_1.default.string().description('Path to file')
});
ErrorManager_1.default.register('ImportManager', 'IM_JSON_INCORRECT', 'Import file json incorrect', {
...
ErrorManager_1.default.register('ImportManager', 'IM_CLASS_PATH_ERROR', 'Error import class - No acts', {
    path: Rule_1.default.string().description('Class path string')
});
ErrorManager_1.default.register('ImportManager', 'IM_CLASS_VENDOR_ERROR', 'Error import class - vendor not found', {
    path: Rule_1.default.string().description('Class path string')
});
ErrorManager_1.default.register('ImportManager', 'IM_CLASS_ACT_ERROR', 'Error import class - class act = undefined', {
    path: Rule_1.default.string().description('Class path string')
});
class ImportManager {
    /**
