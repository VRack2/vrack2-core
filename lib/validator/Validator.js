...
ErrorManager_1.default.register('Validator', 'VR_TYPE_NOT_EXISTS', 'Type not exists', {});
ErrorManager_1.default.register('Validator', 'VR_NOT_PASS', 'Validation error - data not pass', {});
ErrorManager_1.default.register('Validator', 'VR_VALIDATION_INTERNAL', 'An unexpected error occurred during validation', {});
class Validator {
    /**
