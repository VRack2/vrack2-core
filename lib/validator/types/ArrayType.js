...
ErrorManager_1.default.register('Validator', 'VR_IS_NOT_ARRAY', 'Value must be an array', {});
ErrorManager_1.default.register('Validator', 'VR_ARRAY_CONTENT_ERROR', 'Validation error inside the array data', {});
