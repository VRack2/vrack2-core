...
class StringType extends BasicType_1.default {
    constructor() {
        ...
        this.checkers.set(IValidationSubrule_1.SubruleNames.maxLength, (obj, key, sub) => this.checkMaxLength(obj, key, sub));
        this.checkers.set(IValidationSubrule_1.SubruleNames.minLength, (obj, key, sub) => this.checkMinLength(obj, key, sub));
    }
    /**
    ...
    */
    maxLength(max) {
        this.addSubrule(IValidationSubrule_1.SubruleNames.maxLength, max);
        return this;
    }
    /**
    ...
    */
    minLength(min) {
        this.addSubrule(IValidationSubrule_1.SubruleNames.minLength, min);
        return this;
    }
    /**
...
ErrorManager_1.default.register('Validator', 'VR_IS_NOT_STRING', 'Value must be a string', {});
ErrorManager_1.default.register('Validator', 'VR_STRING_MAX_LENGTH', 'The maximum string length is limited', {});
ErrorManager_1.default.register('Validator', 'VR_STRING_MIN_LENGTH', 'The minimum string length is limited', {});
