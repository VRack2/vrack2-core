...
_1.ErrorManager.register('Bootstrap', 'BTSP_CLASS_ID_NOT_FOUND', 'Bootstrap class id not found', {
    id: _1.Rule.string().description('Class identify')
});
_1.ErrorManager.register('Bootstrap', 'BTSP_INSTANCE_OF_INCORRECT', 'Bootstrap class id is not a class defined by check', {
    id: _1.Rule.string().description('Class identify')
});
_1.ErrorManager.register('Bootstrap', 'BTSP_MUST_BE_BOOTCLASS', 'The class must be inherited from BootClass', {
