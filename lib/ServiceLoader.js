...
/***** ********      LOADER ERROR      ********************/
ErrorManager_1.default.register('ServiceLoader', 'FBDRkSAWnlcc', 'CTR_ERROR_INIT_DEVICE', 'Device initialization error', {
    deviceConfig: Rule_1.default.object().description('Device configuration')
});
ErrorManager_1.default.register('ServiceLoader', '96UX24PTyFU7', 'CTR_ERROR_INIT_CONNECTION', 'Connection initialization error', {
    connection: Rule_1.default.string().description('Connection string')
});
ErrorManager_1.default.register('ServiceLoader', 'e090R0MLyb7y', 'CTR_CONF_EXTENDS_PROBLEM', 'Problem with extending service configuration.', {});
ErrorManager_1.default.register('ServiceLoader', '0HVa3cO1E2vB', 'CTR_INCORRECT_DEVICE_ID', 'Incorrect device id', {});
ErrorManager_1.default.register('ServiceLoader', '2RZznI3JDNUW', 'CTR_ERROR_PREPARE_OPTIONS', 'An error occurred while preparing options', {
